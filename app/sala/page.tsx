    ...
    return (
      <div style={{ background: "white", border: `1px solid ${urgente ? "#fecaca" : "#e2e8f0"}`, borderLeft: `4px solid ${urgente ? "#dc2626" : TEAL}`, borderRadius: 12, padding: "12px 16px", display: "flex", alignItems: "center", gap: 14, flexWrap: "wrap" }}>
        ...
        <div style={{ display: "flex", gap: 6, flexShrink: 0 }}>
          ...
          {it.estado === "atendiendo" && it.pacientes && <Link href={`/pacientes/${it.pacientes.id}`} title="Abrir ficha clínica" style={{ background: "#eef0e0", border: "1px solid #cdd6a8", borderRadius: 7, padding: "6px 12px", fontSize: 12.5, color: "#4b5a2c", fontWeight: 700, textDecoration: "none" }}>📋 Ficha clínica</Link>}
