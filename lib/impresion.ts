...
<div class="page">
  ...
  <div class="firma-box">
    ...
    <div class="firma-linea">Firma y sello<br/><span style="font-size:10px;color:#aaa;">${empresaNombre()}</span></div>
  </div>
  <div class="footer">${empresaFooterHTML()}</div>
</div></body></html>`
...
export function imprimirReciboCobroMasivo(
  ...
  const css = `@page{size:A4;margin:15mm}*{box-sizing:border-box}html,body{margin:0;padding:0;font-family:Arial;background:#e5e7eb}.acciones{display:flex;gap:10px;padding:12px 16px;background:#f8fafc;border-bottom:1px solid #e2e8f0;position:sticky;top:0;z-index:10}.page{width:180mm;min-height:267mm;margin:16px auto;background:white;padding:24px;display:flex;flex-direction:column;box-shadow:0 2px 8px rgba(0,0,0,.12)}.logo{height:130px;display:block}.empresa-info{font-size:11px;color:#555;margin-top:4px;line-height:1.6}.header{display:flex;justify-content:space-between;align-items:flex-start;border-bottom:2px solid #5b6b34;padding-bottom:14px;margin-bottom:16px}.header-right{text-align:center;padding-top:4px}.titulo{font-size:20px;font-weight:800;color:#5b6b34;margin:0 0 6px}.nro-doc{font-size:15px;font-weight:700;color:#111;margin:0 0 4px}.fecha-doc{font-size:12px;color:#555;margin:0}.cliente-row{padding:10px 14px;background:#f8fafc;border:1px solid #e2e8f0;border-radius:6px;font-size:12px;line-height:1.9;margin-bottom:16px}table{width:100%;border-collapse:collapse}thead th{background:#5b6b34;color:white;padding:9px 10px;font-size:11px;font-weight:700;text-align:left;text-transform:uppercase;letter-spacing:.4px}.total-box{margin-top:20px;display:flex;justify-content:flex-end}.total-inner{width:280px}.total-pagado{background:#d3f9d8;border:2px solid #2f9e44;border-radius:10px;padding:14px 18px;text-align:center}.total-pagado-label{font-size:11px;color:#2f9e44;font-weight:700;text-transform:uppercase;letter-spacing:.5px;margin:0 0 6px}.total-pagado-monto{font-size:28px;font-weight:800;color:#2f9e44;margin:0}.footer{margin-top:auto;padding-top:16px;border-top:1px solid #eee;font-size:10px;color:#aaa;text-align:center}.firma-box{margin-top:36px;display:flex;justify-content:space-between;font-size:11px;color:#555}.firma-linea{border-top:1px solid #555;width:200px;text-align:center;padding-top:6px}@media print{body{background:white}.acciones{display:none}.page{width:100%;min-height:calc(297mm - 30mm);margin:0;padding:16px;box-shadow:none}tr{page-break-inside:avoid}}`
...
<div class="page">
  <div class="header">
    ...
    <div class="header-right">
      ...
      ${afectadas.length > 1 ? `<div style="margin-top:6px;background:#eef0e0;border:1px solid #5b6b34;border-radius:6px;padding:3px 10px;font-size:11px;color:#5b6b34;font-weight:700;">${afectadas.length} facturas incluidas</div>` : ""}
    </div>
  </div>
  ...
  <div class="total-box"><div class="total-inner">
    ...
    ${Number(creditoAplicado || 0) > 0 ? `<div style="margin-top:8px;background:#eef0e0;border:1px solid #5b6b34;border-radius:8px;padding:10px 16px;text-align:left;font-size:12px;"><p style="margin:0 0 3px;color:#555;display:flex;justify-content:space-between;"><span>Nota de crédito aplicada:</span><span style="font-weight:700;color:#5b6b34;">${f(Number(creditoAplicado))}</span></p><p style="margin:0;color:#555;display:flex;justify-content:space-between;"><span>Efectivo recibido:</span><span style="font-weight:700;color:#2f9e44;">${f(Math.max(0, totalCobrado - Number(creditoAplicado)))}</span></p></div>` : ""}
  </div></div>
  <div class="firma-box">
    <div class="firma-linea">Firma y aclaración<br/><span style="font-size:10px;color:#aaa;">Cliente</span></div>
    <div class="firma-linea">Firma y sello<br/><span style="font-size:10px;color:#aaa;">${empresaNombre()}</span></div>
